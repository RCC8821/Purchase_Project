...
//     // ✅ Sab async kaam parallel chalao - time bachao
...
//     // ✅ Photo upload aur UIDs parallel chalao
...
//       // UIDs generate karo (ek ek karke - sequence zaroori hai)
//       ...validItems.map((_, i) =>
//         generateUID('Site_Exp_FMS', `SITE`).then(uid => {
//           console.log(`[UID] Item ${i + 1}: ${uid}`);
//           return uid;
//         })
//       ),
//     ]);
