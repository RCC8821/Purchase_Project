...
//     allowedUserTypes: ['admin', 'Anish', 'Gourav Singh', 'Govind Ram Nagar'] // ← आप यहाँ अपनी जरूरत के अनुसार यूजर्स बदल सकते हैं
//   };
...
//     const pages = [...allPurchasePages];
//     if (userType) {
//       if (contractorPage.allowedUserTypes.includes(userType)) {
//         pages.push(contractorPage);
//       }
//       if (outstandingPage.allowedUserTypes.includes(userType)) {
...
//     // Outstanding (नया जोड़ा गया - Contractor के ठीक नीचे)
//     ...(userType && outstandingPage.allowedUserTypes.includes(userType)
//       ? [{ 
//           id: outstandingPage.id, 
//           name: outstandingPage.name, 
//           icon: outstandingPage.icon, 
//           path: outstandingPage.path, 
//           component: outstandingPage.component, 
//           pages: [] 
//         }]
//       : []),
//   ];
...
//     'outstanding': { 
//       title: 'Outstanding', 
//       content: 'View and manage outstanding payments, vendor dues, follow-ups and balances.' 
//     },
//     'requirement-received': { title: 'Requirement Form', content: 'View and manage received procurement requirements.' },
//     'approve-required': { title: 'Approve Required', content: 'Review and approve required requests.' },
//     'indent-to-get-quotation': { title: 'Indent (To Get Quotation)', content: 'Manage indents to request quotations.' },
...
const Dashboard = () => {
  ...
  const allPurchasePages = [
    ...
    // अब Contractor और Outstanding भी Purchase FMS के अंदर
    { 
      id: 'contractor-purchase-form', 
      name: 'Contractor Purchase Form', 
      icon: FileText, 
  ...
  const getAllowedPages = () => {
    // अब सिर्फ allPurchasePages से ही सब मिलेंगे (कोई अलग push नहीं)
    return allPurchasePages.filter(page => page.allowedUserTypes.includes(userType));
  };
  ...
  const menuItems = [
    { id: 'purchase-fms', name: 'Purchase FMS', icon: ShoppingCart, path: null, pages: getPurchasePages() },
    { id: 'Sheet-Link', name: 'Sheet Link', icon: FileText, url: 'https://docs.google.com/spreadsheets/d/18bmeQLqAOqleKS9628izEnirrRwOqkC0G_pEYGOsO-Y/edit?gid=0#gid=0', pages: [] },
    // Contractor और Outstanding अब अलग से नहीं दिखेंगे — Purchase FMS के अंदर चले गए
  ];
