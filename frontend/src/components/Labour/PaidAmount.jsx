                  ...
                  <div className="border-t border-gray-100 pt-3">
                    <div className="grid grid-cols-2 gap-2 mb-2">
                      <div className="bg-purple-50 rounded-lg p-2">
                        <p className="text-xs text-purple-600">🏢 Company Head</p>
                        <p className="font-bold text-purple-700">₹{(parseFloat(item.Revised_Company_Head_Amount_4) || 0).toLocaleString()}</p>
                      </div>
                      <div className="bg-blue-50 rounded-lg p-2">
                        <p className="text-xs text-blue-600">👷 Contractor Head</p>
                        <p className="font-bold text-blue-700">₹{(parseFloat(item.Revised_Contractor_Head_Amount_4) || 0).toLocaleString()}</p>
                      </div>
                    </div>
                    
                    <div className={`rounded-xl p-3 text-center ${isSelected ? 'bg-amber-100' : 'bg-gradient-to-r from-amber-50 to-orange-50'}`}>
                      <p className="text-xs text-amber-700 mb-1">💰 Total Payable Amount</p>
                      <p className="font-bold text-amber-800 text-xl">₹{totalAmount.toLocaleString()}</p>
                    </div>
                  </div>
