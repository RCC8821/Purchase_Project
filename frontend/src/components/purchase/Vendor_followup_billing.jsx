          ...
          <div className="min-h-screen flex items-start justify-center pt-10 pb-10 px-4">
            ...
            >
              <div className="px-4 py-3 border-b border-gray-200">
                <h3 className="text-base font-semibold text-gray-800">Select PO Number</h3>
              </div>
              ...
              <thead className="bg-gray-100">
                <tr>
                  {[
                    ...
                    'Status 12', 'Follow-Up Count 12', 'Remark 12', 'Vendor Contact'
                  ].map(header => (
                ...
                {requests.map((r, i) => (
                  <tr key={`${r.UID}-${i}`} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    ...
                    <td className={`px-4 py-2 text-sm font-medium ${
                      r.status12 === 'Hold' ? 'text-red-600' :
                      r.status12 === 'Received' ? 'text-green-600' :
                      'text-gray-700'
                    }`}>
                      {r.status12 || '-'}
                    </td>
