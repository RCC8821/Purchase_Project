...
//       // ← Most important lines – add these
//       console.log("API full response:", res);
//       console.log("API status:", res.status);
//       console.log("API data (complete object):", res.data);
      
//       // Optional – log each field separately so it's easier to read
//       console.log("siteNames:", res.data.siteNames);
//       console.log("materialTypes:", res.data.materialTypes);
//       console.log("remarks:", res.data.remarks);
//       console.log("siteSupervisorMap:", res.data.siteSupervisorMap);
//       console.log("materialMap:", res.data.materialMap);
//       console.log("unitMap:", res.data.unitMap);
//       // if backend also sends supervisorNames:
//       // console.log("supervisorNames:", res.data.supervisorNames);
...
//       } else if (err.request) {
//         console.log("No response received – network issue?", err.request);
//       } else {
//         console.log("Something went wrong while setting up request:", err.message);
//       }
